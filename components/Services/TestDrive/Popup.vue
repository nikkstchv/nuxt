  ...
  <UIBaseOverlay :is-open="isOpenPopup" @click="handleClose()">
    <UISidePanel class="form__side-panel" :is-open="isOpenPopup">
      <div v-if="isOpenPopup" class="service-form-popup">
        ...
        <LazyServicesTestDriveBlockCode
          v-if="step === 1"
...
export default {
  ...
  computed: {
    ...mapState(useTestDriveStore, ['isOpenPopup']),
  },
  methods: {
    handleClose () {
      if (this.step === 2) {
      ...
      this.onCloseTestDrivePopup()
    },
    ...mapActions(useTestDriveStore, {
      onCloseTestDrivePopup: 'onClose',
    }),
  },
}
</script>
