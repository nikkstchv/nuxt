        ...
        <div class="container">
          <div class="card">
            <div class="card__col card__col--photo">
              ...
              >
                <picture>
                  <nuxt-img :src="`${cdnUrl}/i/img/terlyukevich-a3.jpg`" alt="Терлюкевич Андрей Владимирович" /></picture>
              </div>
            </div>
            <div class="card__col card__col--info">
              <div class="card__slot card__slot--name">
                ...
                >
                  ...
                  <span class="slot__value slot__value--name">Терлюкевич Андрей Владимирович</span>
                </div>
              </div>
              <div class="card__slot">
                ...
                >
                  ...
                  <span class="slot__value">Группа компаний «АвтоСпецЦентр»</span>
                </div>
              </div>
              <div class="card__slot">
                <div
                ...
                >
                  ...
                  <span class="slot__value">Генеральный директор</span>
                </div>
              </div>
              <div class="card__slot">
                <div
                ...
                >
                  ...
                  <span class="slot__value">
                    <a
                      class="link-no-underline comagic_phone2_link"
              ...
              <div class="card__slot">
                ...
                >
                  ...
                  <span class="slot__value">
                    <a
                      class="link-no-underline"
                      href="mailto:Andrey.Terlyukevich@ascgroup.ru"
                    >Andrey.Terlyukevich@ascgroup.ru</a>
                  </span>
                </div>
              </div>
              <div class="card__slot card__slot--btn">
                ...
                >
                  <a
                    :href="`${cdnUrl}/i/vcf/terlyukevich_andrej_vladimirovich.vcf`"
                    class="btn btn--white btn--size-m"
                  >Сохранить карточку контакта</a>
                </div>
              </div>
              <div
                class="card__slot card__slot--100 aos-init"
                data-aos="fade-up"
                data-aos-duration="300"
                data-aos-delay="150"
              >
                <div class="map-nav">
                  ...
                  <ul class="map-nav-list">
                    <li class="map-nav-list__item">
                      <a
                        href="https://yandex.ru/maps/org/137352583024"
                        class="m-nav"
                        target="_blank"
                        rel="nofollow"
                      >
        ...
        <div class="f-content">
          <div class="f-content__item f-contact">
            <a
              ...
              href="https://ascgroup.ru/"
              target="_blank"
              rel="nofollow"
            >ascgroup.ru</a>:
            <a
              class="f-a comagic_phone2_link"
              rel="nofollow"
              href="tel:+74957855505"
            >+7 (495) 785-55-05</a>
            Москва
...
const title = 'Терлюкевич Андрей Владимирович - АвтоСпецЦентр'
const head = {
  title,
  meta: [
    {
      hid: 'og:image',
      property: 'og:image',
      content: `${cdnUrl}/i/img/terlyukevich-a3.jpg`,
    },
    {
      hid: 'og:title',
      name: 'og:title',
...
@import 'assets/styles/components/BusinessCard/styles-asc';
</style>
