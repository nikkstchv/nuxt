...
const seoDefault = {
  title: `Купить BMW чёрного цвета с пробегом в ${location}, цены на чёрные БМВ – ${holdingName}`,
  description: `Цены на чёрные BMW с пробегом в ${location}. Продажа подержанных БМВ чёрного цвета. Автомобили на привлекательных условиях в кредит с гарантией в ${holdingName}`,
}
